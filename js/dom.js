document.addEventListener("DOMContentLoaded", function () {
	...
	if (window.location.href.includes("/devolution.")) {
		...
		const xhttp = new XMLHttpRequest();
		xhttp.open("GET", "http://127.0.0.1:4000/getLends/" + data.id_usuario);
		xhttp.send();
		xhttp.onreadystatechange = function () {
			const response = JSON.parse(this.responseText);
	...
	if (window.location.href.includes("/admin-devolution.")) {
		const data = JSON.parse(localStorage.getItem("data"))
		const xhttp = new XMLHttpRequest();
		xhttp.open("GET", "http://127.0.0.1:4000/getAllLendsE/");
		xhttp.send();
		xhttp.onreadystatechange = function () {
			const response = JSON.parse(this.responseText);
			const container = document.getElementById("container");
	...
	if (window.location.href.includes("/devolutionview.")) {
		...
		const xhttp = new XMLHttpRequest();
		xhttp.open("GET", "http://127.0.0.1:4000/getLend/" + data);
		xhttp.send();
		xhttp.onreadystatechange = function () {
			if (this.readyState === 4 && this.status === 200) {
				const response = JSON.parse(this.responseText);
	...
	if (window.location.href.includes("/admin-historial.")) {
		const xhttp = new XMLHttpRequest();
		xhttp.open("GET", "http://127.0.0.1:4000/getAllLends/");
		xhttp.send();
		xhttp.onreadystatechange = function () {
			const response = JSON.parse(this.responseText);
			const container = document.getElementById("container");
	...
	if (window.location.href.includes("/admin-users.")) {
		const xhttp = new XMLHttpRequest();
		xhttp.open("GET", "http://127.0.0.1:4000/getUsers/");
		xhttp.send();
		xhttp.onreadystatechange = function () {
			const response = JSON.parse(this.responseText);
			const container = document.getElementById("container");
